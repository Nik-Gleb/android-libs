...
/**
 * @author gleb
 * @since 1.0, 10/07/2018
 */
class CollectionGestureDetector {
  /**
   * The listener that is used to notify when gestures occur.
   * If you want to listen for all the different gestures then implement
   * this interface. If you only want to listen for a subset it might
   * be easier to extend {@link GestureDetector.SimpleOnGestureListener}.
   */
   ...
   * {@link GestureDetector.OnGestureListener}, {@link GestureDetector.OnDoubleTapListener}, and {@link GestureDetector.OnContextClickListener}
  ...
  private GestureDetector.OnContextClickListener mContextClickListener;
   ...
   */
  public CollectionGestureDetector(Context context, GestureDetector.OnGestureListener listener) {
   ...
   * @throws NullPointerException if {@code listener} is null.
   */
  public CollectionGestureDetector(Context context, GestureDetector.OnGestureListener listener, Handler handler) {
    if (handler != null) {
    ...
    if (listener instanceof GestureDetector.OnContextClickListener) {
      setContextClickListener((GestureDetector.OnContextClickListener) listener);
    }
    init(context);
  }
   ...
   * @throws NullPointerException if {@code listener} is null.
   */
  public CollectionGestureDetector(Context context, GestureDetector.OnGestureListener listener, Handler handler, boolean unused) {
